        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryAmount = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DeliveryCurrency = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DeliveryDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DeliveryResponse = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DeliveryResponseCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DeliveryResponseMessage = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderAmount = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrderCurrency = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrderDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrderResponse = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrderResponseCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrderResponseMessage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Customers_CustommerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Carts_Customers_CustommerId",
                        column: x => x.CustommerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
